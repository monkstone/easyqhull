 ...
 * </pre> will cause QuickHull3D to be tested on a number of randomly choosen
 * input sets, with degenerate points added near the edges and vertics of the
 * convex hull.
 *
 * <p>The command
 * <pre>
 *   java quickhull3d.QuickHull3DTest -timing
 * </pre> will cause timing information to be produced instead.
 *
...
public class QuickHull3DTest {
     ...
     * <code>num</code> points whose x, y, and z values are randomly chosen
    ...
    /**
     * Returns the coordinates for
     * <code>num</code> randomly chosen points which are degenerate which
     * respect to the specified dimensionality.
     *
     * @param num number of points to produce
     * @param dimen dimensionality of degeneracy: 0 = coincident, 1 = colinear,
     * 2 = coplaner.
     * @return array of coordinate values
     */
    ...
    /**
     * Returns the coordinates for
     * <code>num</code> points whose x, y, and z values are randomly chosen to
     * lie within a sphere.
     *
     * @param num number of points to produce
    ...
    /**
     * Returns the coordinates for
     * <code>num</code> points whose x, y, and z values are each randomly chosen
     * to lie within a specified range, and then clipped to a maximum absolute
     * value. This means a large number of points may lie on the surface of
     * cube, which is useful for creating degenerate convex hull situations.
     *
     * @param num number of points to produce
     * @param range coordinate values will lie between -range and range, before
     * clipping
     * @param max maximum absolute value to which the coordinates are clipped
     * @return array of coordinate values
     */
     ...
     *
     * @param gridSize number of points in each direction, so that the total
     * number of points produced is the cube of gridSize.
     * @param width distance between each point along a particular direction
     * @return array of coordinate values
     */
    ...
    public void timingTests() {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            System.out.println(n + " points: " + (t1 - t0) / (double) count
                    + " msec");
        }
    }
     ...
     *
     * <p>If the option
     * <code>-timing</code> is supplied, then timing information is produced
     * instead.
     * @param args 
     */
